		  ...
		  begin
		    ...
		    begin
		      ...
		      if (Color = '') and (Length(Tag) = 11) then
		        if CharIsHexDigit(Tag[5]) and CharIsHexDigit(Tag[6]) and
               CharIsHexDigit(Tag[7]) and CharIsHexDigit(Tag[8]) and
               CharIsHexDigit(Tag[9]) and CharIsHexDigit(Tag[10]) then
